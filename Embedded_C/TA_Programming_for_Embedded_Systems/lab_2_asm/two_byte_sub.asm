...
; ***** PROGRAM INFORMATION **********************************************
; Info:
; Given instructions makes the program a bit too complicated -> Since we need to subtract
...
; Once the 16-bit subtraction is completed, we store the sum at the addresses our
; y-reg points at.
...
.equ	secondValueHigh	=		0x01		; 0x01:01	= 0x0103
.equ	xRegLow			=		0x00
