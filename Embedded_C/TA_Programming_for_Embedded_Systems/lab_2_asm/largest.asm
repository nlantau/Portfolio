...
; points at). In subroutine findLargest, the last added element in our "array"
; will be loaded and compared to the currently highest value (at start, = 0 ).
; If the loaded value is greater, it will overwrite the previous highest value.
; This way, we compare each element of our array with the currently highest value
; and replace the highest value if we find a larger number.
